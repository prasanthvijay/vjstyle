				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							...
							<button class="btn btn-primary waves-effect waves-light m-t-10" onclick="loadAddOrEditContentWithModal('getAddOrEditUserMasterContent','usertypeid=6','modalContentArea')">Add Supplier</button>
						</div>
					</div>
				</div>
			</div>
		...
		if(approve){
			...
			$.ajax({
				...
				success: function (responseFromSite) {
					$.Notification.notify('success','top right', 'Delete Supplier', 'Supplier was successfully Deleted ')
					loadUsersListDetails(postUrl, postData, displayDiv);
				}
			});
		}
