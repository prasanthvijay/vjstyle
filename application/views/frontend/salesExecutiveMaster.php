		...
		<div class="row">
			<div class="col-md-12">
				<div class="card-box table-responsive">
					...
					<button class="btn btn-primary waves-effect waves-light m-t-10" data-toggle="modal" data-target="#panel-modal">Add Sales Executive</button>
				</div>
			</div>
		</div>
		<!-- End row -->
