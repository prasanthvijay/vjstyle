...
<?php $percentage = $receiptList[0]['total']/100; ?>
                            <div class="circliful-chart" data-dimension="90" data-text="<?php echo $percentage; ?>%" data-width="5" data-fontsize="14" data-percent="<?php echo $percentage; ?>" data-fgcolor="#5fbeaa" data-bgcolor="#ebeff2"></div>
                            <h3 class="text-success counter"><?php echo $receiptList[0]['total']; ?></h3>
                            <p class="text-muted text-nowrap">Total Sales </p>
                        </div>
                    </div>
