				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							...
							<button class="btn btn-primary waves-effect waves-light m-t-10" onclick="loadAddOrEditContentWithModal('getAddOrEditUserMasterContent','usertypeid=2','modalContentArea')">Add Admin</button>
						</div>
					</div>
				</div>
			</div>
