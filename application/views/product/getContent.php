...
<?php } if($type == 'product') { ?>
					<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <select class="select2 form-control" id="brandname" name="brandname" onchange="productQtyandPrice(this.value)">
...
<?php } if($type=='productQtyandPrice') { ?>                                        

 <div class="form-group">
                                            <label class="col-sm-3 control-label">Avalable Quantity</label>
                                            <div class="col-sm-6">
					
                                                <input type="text"  id="quantity" name="quantity" class="form-control" required readonly placeholder="Avalable Quantity" value="<?php echo $productQytArray[0]['avalableQty']; ?>" />
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Increment Quantity</label>
                                            <div class="col-sm-6">
                                                <input type="text" id="Incquantity" name="Incquantity"  class="form-control" required  placeholder="Increment Quantity" />
                                            </div>
                                        </div></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="price" name="price" class="form-control"  value="<?php echo $productQytArray[0]['price']; ?>" required  readonly placeholder="Avalable Price" />
                                            </div>
                                        </div>
